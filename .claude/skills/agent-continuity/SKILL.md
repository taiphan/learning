...
**Applies to every agent persona** (`.cursor/agents/*.md` and synced copies) — not only the default agent. When you @ mention or adopt a persona, SESSION read/update rules are still mandatory.
...
- [ ] Follow `.cursor/commands/understand-project.md`
...
| Command | File |
|---------|------|
| `/understand` | `.cursor/commands/understand-project.md` |
