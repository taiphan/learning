...
If **`.agent/onboarding.complete`** is missing, run **`.cursor/commands/understand-project.md`** first (present summary, write `.agent/PROJECT.md`), then continue with this resume workflow.
