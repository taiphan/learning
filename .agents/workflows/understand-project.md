...
- **Automatic:** `.agent/onboarding.complete` is missing (see `.agent/rules/agent-continuity.md`)
...
5. **Hub files** — `AGENTS.md`, `.agents/CURSOR.md`, `.agents/CLAUDE.md`, `.agents/KIRO.md`, `GEMINI.md` (whichever exist)
...
If they asked to **resume** (`/resume`), run `.agents/workflows/resume.md` after Phase 6.
