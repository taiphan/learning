...
| [lab/WEEKS.md](lab/WEEKS.md) | 52-week index table |
| [lab/](lab/) | Runnable Week 1–2 exercises + sample data |
...
python3 curriculum/scaffold_learning_lab.py   # week exercise stubs only
