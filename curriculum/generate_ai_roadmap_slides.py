...
def generate():
    ...
    builders = [
        s_title,
        s_start_target,
        lambda p, i: s_phase_cards(p, i, "Y1 Q1 — Technologist (Weeks 1–12)",
                                    "Career gate: ship code + BRD bridge",
                                    [(CLAY, "Python + Git", "Weeks 1–4 · CP0"),
                                     (SKY, "SQL + pandas", "Weeks 5–8 · CP1 · H0"),
                                     (OLIVE, "EDA + ML start", "Weeks 9–12"),
                                     (FIG, "Deliverable", "BRD scorer + KPI queries")]),
        lambda p, i: s_phase_cards(p, i, "Y1 Q2 — ML hire signal (Weeks 13–24)",
                                    "Portfolio piece 1",
                                    [(SKY, "PD model", "Weeks 13–16 · CP2 · H1"),
                                     (CLAY, "Metrics + SHAP", "Weeks 17–20"),
                                     (OLIVE, "NLP + RAG start", "Weeks 21–24 · CP3"),
                                     (FIG, "Apply signal", "Classical ML + docs")]),
        lambda p, i: s_phase_cards(p, i, "Y1 Q3 — GenAI production (Weeks 25–36)",
                                    "Portfolio piece 2",
                                    [(FIG, "RAG + agent", "Weeks 25–32 · H2 · CP4"),
                                     (CLAY, "FastAPI + Docker", "Weeks 33–36"),
                                     (OLIVE, "Interview core", "OCB/NAB GenAI cluster")]),
        lambda p, i: s_phase_cards(p, i, "Y1 Q4 — Apply (Weeks 37–52)",
                                    "Career gate: apply AI Engineer",
                                    [(CACTUS, "CI + governance", "Weeks 37–40 · CP5 · H3"),
                                     (OLIVE, "Use case 2 + CV", "Weeks 41–48 · CP6"),
                                     (NAVY, "Apply + H4 deck", "Weeks 49–52 · OCB/NAB/VPBank")]),
        s_weekly,
        s_track_b,
        s_domain_edge,
        s_resources,
