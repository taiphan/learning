...
**All agent personas** (`.kiro/agents/*.md`) must read SESSION at session start and update it before ending or switching roles — see the **Agent continuity (mandatory)** section in each persona file.
...
1. Follow **`.kiro/commands/understand-project.md`** ("Understanding this project structure")
