...
**Data source:** [learning_data.py](learning_data.py) · [learning-lab/WEEKS.md](learning-lab/WEEKS.md)  
**Solutions folder:** [learning-lab/exercises/solutions/](learning-lab/exercises/solutions/)
...
**File:** `learning-lab/exercises/week01_brd_checklist.py`  
**Solution:** [solutions/week01_brd_checklist_solution.py](learning-lab/exercises/solutions/week01_brd_checklist_solution.py)

### Steps

1. `cd ai-factory/learning-lab/exercises`
...
3. Copy `ai-factory/learning-lab/` into the repo.
4. Create `README.md`:
...
| Data | [sample_loans.csv](learning-lab/data/sample_loans.csv) |
...
**File:** [week05_queries.sql](learning-lab/sql/week05_queries.sql)  
**Solution:** [week05_queries_solution.sql](learning-lab/sql/week05_queries_solution.sql)

### Setup steps

```bash
cd ai-factory/learning-lab
sqlite3 loans.db
```
...
Create `learning-lab/notebooks/01_lending_kpis.ipynb`
...
Run solution: `python3 learning-lab/exercises/solutions/week02_loan_rules_solution.py`
