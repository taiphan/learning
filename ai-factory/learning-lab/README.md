...
All exercises are **generated from** `ai-factory/learning_data.py` via:

```bash
python3 ai-factory/generate_all_weeks.py      # lab code only
python3 ai-factory/generate_all_learning.py   # JSON + lab + all slide decks
```
