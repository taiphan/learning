...
**Rule:** Read one unit → do the matching exercise in [learning-lab/](learning-lab/) the same day.  
...
📦 **After Step 1:** Complete [week01_brd_checklist.py](learning-lab/exercises/week01_brd_checklist.py) + [week02_loan_rules.py](learning-lab/exercises/week02_loan_rules.py)
...
📦 **After Step 2:** [sql/week05_queries.sql](learning-lab/sql/week05_queries.sql) + notebook `01_lending_kpis.ipynb`
...
1. **Today:** Python.org tutorial §1 + start [week01_brd_checklist.py](learning-lab/exercises/week01_brd_checklist.py)
