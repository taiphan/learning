...
def _build_weeks() -> list[dict]:
    ...
    add(1, "Python syntax — BRD audit", "foundation", 1,
        ...
        "learning-lab/exercises/week01_brd_checklist.py",
    ...
    add(2, "Functions & CSV loan rules", "foundation", 1,
        ...
        "learning-lab/exercises/week02_loan_rules.py",
    ...
    add(3, "Dicts & weighted BRD score", "foundation", 1,
        ...
        "learning-lab/exercises/week03_brd_weighted_score.py",
    ...
    add(4, "OOP scorecard + Git", "foundation", 2,
        ...
        "learning-lab/exercises/week04_brd_scorecard.py",
    ...
    add(9, "Load credit dataset", "ml", 5,
        ...
        "learning-lab/notebooks/02_eda_credit.ipynb",
        "Start EDA notebook",
    ...
    add(20, "SHAP explainability", "ml", 7,
        "SHAP intro notebook",
        "learning-lab/exercises/week20_shap.py",
    ...
    add(24, "Document classifier", "nlp", 8,
        ...
        "learning-lab/exercises/week24_doc_classifier.py",
    ...
    add(25, "LangChain RAG quickstart", "genai", 9,
        ...
        "learning-lab/exercises/week25_rag_cli.py",
    ...
    add(27, "PDF / markdown loader", "genai", 9,
        ...
        "learning-lab/projects/policy-rag/",
    ...
    add(33, "FastAPI /ask endpoint", "production", 11,
        ...
        "learning-lab/projects/week33_fastapi/main.py",
    ...
    add(50, "Anthropic stretch research", "career", 14,
        ...
        "ai-factory/anthropic-career-adaptation.md",
...
META = {
    ...
    "hours_per_week": 10,
    "total_weeks": 52,
    "data_source": "ai-factory/learning_data.py",
    "workbook": "ai-factory/ai-skills-workbook.md",
    "repo_root_docs": "docs/",
    "lab_root": "ai-factory/learning-lab/",
}
