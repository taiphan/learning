...
|---|---|---|---|
| **Track 1 — AI Engineer (GenAI)** | OCB / VPBank AI Engineer, **NAB AIOps/MLOps**, **Anthropic Applied AI (§I)** | **4–6 months** | Governance, BRD, operating model (`ai-factory/`) |
...
| Interview | `ai-factory/interview-kit.md`, `cv-cover-letter.md` |
...
2. Add a `ai-factory/portfolio/` folder with links to GitHub projects as you build them.
