...
**Hands-on lab:** [learning-lab-guide.md](learning-lab-guide.md) — materials, exercises, how to learn · start at [learning-lab/exercises/week01_brd_checklist.py](learning-lab/exercises/week01_brd_checklist.py)
...
```bash
python3 ai-factory/generate_ai_roadmap_slides.py
```

Output: `ai-factory/exports/Zero-to-AI-Expert-Roadmap-Slides.pptx`
