...
- **Runnable exercises** → [learning-lab/exercises/](learning-lab/exercises/)
...
3. APPLY  (20%)  → banking exercise in learning-lab/
...
cp -r /path/to/fe-credit-brd-training/ai-factory/learning-lab ./lab
...
1. Open the exercise file in `learning-lab/exercises/`.
...
**Legend:** 📖 = study · ✍️ = exercise in `learning-lab/` · 📦 = portfolio deliverable
...
```bash
cd ai-factory/learning-lab/exercises
...
**Exercise — SQL (Week 5):**
```sql
-- File: learning-lab/sql/week05_queries.sql
...
**Exercise — RAG (Week 20):** Use synthetic policy text from `learning-lab/data/sample_policy.txt` (create 1-page markdown of fake credit rules).
...
**Exercise — golden eval format (`learning-lab/data/eval_questions.json`):**
```json
[
...
├── lab/                      # copy from ai-factory/learning-lab/
│   ├── data/
│   ├── exercises/
│   ├── sql/
│   └── notebooks/
...
| Path | What |
|---|---|
| [learning-lab/exercises/week01_brd_checklist.py](learning-lab/exercises/week01_brd_checklist.py) | **Start here — Week 1** |
| [learning-lab/exercises/week02_loan_rules.py](learning-lab/exercises/week02_loan_rules.py) | Week 2 — rules engine |
| [learning-lab/data/sample_loans.csv](learning-lab/data/sample_loans.csv) | Practice loan data |
