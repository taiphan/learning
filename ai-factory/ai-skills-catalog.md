...
| **Exercise** | `learning-lab/exercises/week01_brd_checklist.py` · `week02_loan_rules.py` |
...
| **Exercise** | `learning-lab/sql/week05_queries.sql` — branches, roll rates, vintage |
...
```bash
python3 ai-factory/generate_ai_skills_slides.py
```

Output: `ai-factory/exports/AI-Skills-Learning-Slides.pptx` (23 slides)
