...
def s_first30(prs, i):
    ...
    _text(s, 0.55, y + 3.55, 12.2, 0.5,
          [("Full syllabus: ai-factory/zero-to-ai-expert-syllabus.md", 12, True, NAVY)], align=PP_ALIGN.CENTER)
    _footer_slide(s, i)
    return s
...
def s_summary(prs, i):
    ...
    summary_slide(
        ...
        "Run: python3 ai-factory/generate_ai_roadmap_slides.py  ·  Read: zero-to-ai-expert-syllabus.md",
    )
    return s
